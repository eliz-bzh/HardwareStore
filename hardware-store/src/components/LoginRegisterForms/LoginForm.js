                ...
                <Row>
                    <Col>
                        ...
                        <ToggleButtonGroup className='d-flex justify-content-center align-items-center' type="radio" name="options" defaultValue={1}>
                            <ToggleButton value={1} variant="outline-dark" checked={radioValue === 1} name="radio" onChange={(e) => this.setState({radioValue: 1})}>Клиент</ToggleButton>
                            <ToggleButton value={2} variant="outline-dark" checked={radioValue === 2} name="radio" onChange={(e) => this.setState({radioValue: 2})}>Администратор</ToggleButton>
                        </ToggleButtonGroup>
                        {(radioValue === 1) ? (
