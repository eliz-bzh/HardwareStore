    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOrderInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductOrderInfos_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductOrderInfos_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOrderInfos_OrderId",
                table: "ProductOrderInfos",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOrderInfos_ProductId",
                table: "ProductOrderInfos",
                column: "ProductId");
